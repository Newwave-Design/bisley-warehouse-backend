...
interface WmsProduct {
  ...
  thumbnail: string | null; variant_count: number; kit_variant_count: number
  variants: WmsVariant[]
}
        ...
        try {
          ...
          const r = await query(`
            INSERT INTO wms_products
              (medusa_product_id, medusa_variant_id, product_title, product_handle,
               product_status, product_thumbnail, variant_sku, variant_title,
               colour_code, colour_name, variant_thumbnail, manage_inventory,
          ...
          `, [
            product.id, v.id, product.title, product.handle, product.status,
            product.thumbnail, v.sku, v.title, v.colour_code, v.colour_name,
            v.thumbnail, v.manage_inventory, v.is_kit, kitJson, v.inventory_qty,
          ]);
