...
pendingRouter.get('/', authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
...
pendingRouter.post('/:id/approve', authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
...
pendingRouter.post('/:id/delay', authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
...
pendingRouter.post('/:id/cancel', authMiddleware, async (_req: AuthRequest, res: Response) => {
  try {
...
pendingRouter.post('/bulk-approve', authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
