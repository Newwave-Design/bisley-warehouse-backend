...
const STATEMENTS: string[] = [
  ...
  ('little-height-desk-1050', 'Little Height Standing Desk', '1050', 1050, 700, 25, 'Hard Corners', 50, 1150, 800, 125, '[{"field":"title","contains":"little height adjustable desk"}]'::jsonb, 'Real products aren''t split by width in their title - this matches all Little Height Adjustable Desk products regardless of width.', 26),
  ('little-height-desk-1200', 'Little Height Standing Desk', '1200', 1200, 700, 25, 'Hard Corners', 50, 1300, 800, 125, '[{"field":"title","contains":"little height adjustable desk"}]'::jsonb, 'Real products aren''t split by width in their title - this matches all Little Height Adjustable Desk products regardless of width.', 27),
  ...
  ('cyl-desk-1200', 'CYL Height Adjustable Desk', '1200', 1200, 700, 25, 'Hard Corners', 50, 1300, 800, 125, '[{"field":"title","contains":"cyl height adjustable desk"}]'::jsonb, 'Real products aren''t split by width in their title - this matches all CYL Height Adjustable Desk products regardless of width.', 31),
  ('cyl-desk-1400', 'CYL Height Adjustable Desk', '1400', 1400, 700, 25, 'Hard Corners', 50, 1500, 800, 125, '[{"field":"title","contains":"cyl height adjustable desk"}]'::jsonb, 'Real products aren''t split by width in their title - this matches all CYL Height Adjustable Desk products regardless of width.', 32),
  ('cyl-desk-1600', 'CYL Height Adjustable Desk', '1600', 1600, 700, 25, 'Hard Corners', 50, 1700, 800, 125, '[{"field":"title","contains":"cyl height adjustable desk"}]'::jsonb, 'Check with colleague: is desktop height really 25mm, or should it be 80mm like the original sheet''s summary text said? Also not split by width in title.', 33),
